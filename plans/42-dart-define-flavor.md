...
Dart コード、CLI のいずれからも同じ設定ファイルを参照できる基盤を追加する。
...
4. `docs/development.md` に Dev/Prod の CLI 起動コマンドを追記する。
5. Flavor の Dev/Prod 判定、未指定、不正値、全設定値の読み取り、必須値の空文字を
   Unit Test で確認する。
